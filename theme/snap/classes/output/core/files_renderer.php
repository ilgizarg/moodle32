...
/**
 * Snap core files renderer.
 * Overrides core files renderer.
 *
 * @package   theme_snap
...
class files_renderer extends \core_files_renderer {
	 ...
	 * @return string
	 */
	public function fm_print_generallayout($fm) {
		global $OUTPUT;
		$options = $fm->options;
...
<div id="filemanager-' . $clientid . '" class="filemanager fm-loading">
	 ...
	 * @return string
	 */
	public function fm_js_template_iconfilename() {
		$rv = '
<div class="fp-file">
    <a href="#">
	 ...
	 * @return string
	 */
	public function fm_js_template_listfilename() {
		$rv = '
<span class="fp-filename-icon">
	 ...
	 * @return string
	 */
	public function fm_js_template_mkdir() {
		$rv = '
<div class="filemanager fp-mkdir-dlg" role="dialog" aria-live="assertive" aria-labelledby="fp-mkdir-dlg-title">
	 ...
	 * @return string
	 */
	public function fm_js_template_message() {
	 ...
	 * @return string
	 */
	public function fm_js_template_fileselectlayout() {
		global $OUTPUT;
		$strloading = get_string('loading', 'repository');
...
<div class="filemanager fp-select">
	 ...
	 * @return string
	 */
	public function fm_js_template_confirmdialog() {
		$rv = '
<div class="filemanager fp-dlg">
	 ...
	 * @return string
	 */
	public function fp_js_template_generallayout() {
		$rv = '
<div tabindex="0" class="file-picker fp-generallayout" role="dialog" aria-live="assertive">
	 ...
	 * @return string
	 */
	public function fp_js_template_iconfilename() {
		$rv = '
<a class="fp-file" href="#" >
	 ...
	 * @return string
	 */
	public function fp_js_template_listfilename() {
		$rv = '
<span class="fp-filename-icon">
    <a href="#">
        <span class="fp-icon"></span>
	 ...
	 * @return string
	 */
	public function fp_js_template_nextpage() {
		$rv = '
<div class="fp-nextpage">
	 ...
	 * @return string
	 */
	public function fp_js_template_selectlayout() {
		$rv = '
<div class="file-picker fp-select">
	 ...
	 * @return string
	 */
	public function fp_js_template_uploadform() {
		$rv = '
<div class="fp-upload-form">
	 ...
	 * @return string
	 */
	public function fp_js_template_loading() {
		return '
<div class="fp-content-loading">
	 ...
	 * @return string
	 */
	public function fp_js_template_error() {
		$rv = '
<div class="fp-content-error" ><div class="fp-error"></div></div>';
	 ...
	 * @return string
	 */
	public function fp_js_template_message() {
		$rv = '
<div class="file-picker fp-msg" role="alertdialog" aria-live="assertive" aria-labelledby="fp-msg-labelledby">
	 ...
	 * @return string
	 */
	public function fp_js_template_processexistingfile() {
		$rv = '
<div class="file-picker fp-dlg">
	 ...
	 * @return string
	 */
	public function fp_js_template_processexistingfilemultiple() {
		$rv = '
<div class="file-picker fp-dlg">
    <p class="fp-dlg-text"></p>
	 ...
	 * @return string
	 */
	public function fp_js_template_loginform() {
		$rv = '
