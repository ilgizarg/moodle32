...
if ($ADMIN->fulltree) {
	...
	$name = 'theme_snap/copyright';
	$title = new lang_string('copyright', 'theme_snap');
	$description = new lang_string('copyrightdesc', 'theme_snap');
	$default = '';
	...
	// Social media.
	$name = 'theme_snap/vk';
	$title = new lang_string('vk', 'theme_snap');
	$description = new lang_string('vkdesc', 'theme_snap');
	$default = '';
