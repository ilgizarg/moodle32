...
/* Social media links */
$socialmedialinks = '';
if (!empty($PAGE->theme->settings->vk)) {
	$socialmedialinks .= $this->social_menu_link('vk', $PAGE->theme->settings->vk);
}
...
<div id='mrooms-footer' class="helplink text-right">
    <small>
    <?php
$poweredbyrunby = '&copy; ' . $PAGE->theme->settings->copyright . ' ' . date("Y");
?>
