...
if ($ADMIN->fulltree) {
    ...
    // Footnote setting.
    $name = 'theme_boost/footnote';
    $title = get_string('footnote', 'theme_boost');
    $description = get_string('footnotedesc', 'theme_boost');
    $default = '';
    ...
    // Copyright setting.
    $name = 'theme_boost/copyright';
    $title = get_string('copyright', 'theme_boost');
    $description = get_string('copyrightdesc', 'theme_boost');
    $default = '';
