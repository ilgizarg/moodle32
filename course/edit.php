...
$workprogrammfilesoptions = course_workprogramfiles_options($course);
if (!empty($course)) {
	// Add context for editor.
	$editoroptions['context'] = $coursecontext;
	$editoroptions['subdirs'] = file_area_contains_subdirs($coursecontext, 'course', 'summary', 0);
	$course = file_prepare_standard_editor($course, 'summary', $editoroptions, $coursecontext, 'course', 'summary', 0);
	$editoroptions['subdirs'] = file_area_contains_subdirs($coursecontext, 'course', 'instruction', 0);
	$course = file_prepare_standard_editor($course, 'instruction', $editoroptions, $coursecontext, 'course', 'instruction', 0);
	if ($overviewfilesoptions) {
		file_prepare_standard_filemanager($course, 'overviewfiles', $overviewfilesoptions, $coursecontext, 'course', 'overviewfiles', 0);
	}

	if ($workprogrammfilesoptions) {
		file_prepare_standard_filemanager($course, 'workprogrammfiles', $overviewfilesoptions, $coursecontext, 'course', 'workprogrammfiles', 0);
	}
	...
	$course = file_prepare_standard_editor($course, 'instruction', $editoroptions, null, 'course', 'instruction', null);
	if ($overviewfilesoptions) {
		file_prepare_standard_filemanager($course, 'overviewfiles', $overviewfilesoptions, null, 'course', 'overviewfiles', 0);
	}
	if ($workprogrammfilesoptions) {
		file_prepare_standard_filemanager($course, 'workprogrammfiles', $overviewfilesoptions, null, 'course', 'workprogrammfiles', 0);
	}
}
